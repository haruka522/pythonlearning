# to import functions from functions.py
# from functions import get_todos, write_todos
import functions

# if the file is in the other folder, we need to specify the path
# myfolder/something.py
...
while True:
    ...
    if user_input.startswith("add"):
        ...
        try:
            # if we only import functions from functions.py we need to call the function like this:
